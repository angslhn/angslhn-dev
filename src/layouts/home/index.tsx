...
export default function Home(): JSX.Element {
    return (
        <Section name="home">
            <div className="h-[20rem] w-[40rem] flex-col-center border border-gray-950/15 rounded-2xl shadow-[0.1rem_0.1rem_0.4rem] shadow-gray-950/15 backdrop-blur-sm bg-silver-haze/25">
                <div className="flex-col-start h-[15rem] w-11/12 gap-2 !text-black-sapphire">
                    <h1 className="order-2 font-stalinist-one leading-10 tracking-wide text-[2.8rem] font-semibold text-shadow-[0.2rem_0.2rem_0.05rem] text-shadow-gray-950/70">AANG SOLIHIN</h1>
