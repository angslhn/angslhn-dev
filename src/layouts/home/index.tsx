        ...
        <Section name="home">
            <div className="h-[20rem] w-[40rem] flex-col-center border border-charcoal-blue/15 rounded-2xl shadow-[0.1rem_0.1rem_0.4rem] shadow-charcoal-blue/15 backdrop-blur-sm bg-silver-haze/25">
                <div className="flex-col-start h-[15.5rem] w-11/12 gap-3">
                    ...
                    <h2 className="order-1 mb-1 font-jetbrains-mono text-charcoal-blue tracking-wider font-extrabold text-3xl">Heyyy, I&apos;am...</h2>
                    <h2 className="order-3 font-jetbrains-mono text-charcoal-blue tracking-wider font-extrabold text-3xl">Fullstack Developer</h2>
