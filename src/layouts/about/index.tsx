            ...
            <div className="h-[22rem] w-[55rem] flex-row-center">
                <div className="h-full w-[15rem] flex-col-center gap-1.5 ">
                    <div className=" h-[10rem] w-full flex-row-center">
                        <Image className="h-[9rem] w-[9rem] opacity-80 rounded-xl shadow-[0.1rem_0.1rem_0.3rem] shadow-charcoal-blue/30" src={angslhn} alt="Profile Picture" title="Aang Solihin"/>
                    </div>
                    <div className="h-[9rem] w-[90%] flex-col-center gap-2">
                        <strong className="w-full py-1.5 text-center text-[1.1rem] font-extrabold text-silver-haze border border-charcoal-blue/15 rounded-sm bg-charcoal-blue">
                            Aang Solihin
                        </strong>
                        ...
                        <div className="relative w-full flex-row-start gap-1.5 py-1.5 text-silver-haze  border border-charcoal-blue/15 rounded-sm bg-charcoal-blue hover:bg-charcoal-blue/85 transition-colors duration-300">
                            ...
                            <Link href="https://maps.app.goo.gl/zAxCWieZuDX3oXLX6" className="absolute w-full text-center text-sm font-semibold" target="_blank">
                                Sumedang, Indonesia
                            </Link>
                        </div>
                    </div>
                ...
                <div className="h-full w-[40rem] flex-col-center gap-2">
                    <h2 className="hoverable py-1.5 px-3 mb-2 text-center text-2xl font-extrabold text-silver-haze border border-charcoal-blue/15 rounded-sm bg-charcoal-blue backdrop-blur-sm">
                        About Me
                    </h2>
                    <p className="py-1.5 px-3 text-justify text-sm font-semibold border border-charcoal-blue/15 rounded-sm bg-silver-haze/15 backdrop-blur-sm">
