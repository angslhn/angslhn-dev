...
export default function Project(): JSX.Element {
    ...
    return (
        <Section name="project">
            <div className="xxs:h-[45rem] lg:h-[37.5rem] xxs:w-full lg:w-[57rem] flex-col-center">
                <div className="xxs:h-[8rem] xxs:w-[19.5rem] xs:w-[21rem] s:-w-[22.5rem] s-plus:w-[24rem] s-medium:w-[25.5rem] sm:w-[28.5rem] lg:w-full flex-col-center gap-2.5">
                    ...
                    <p className="font-jetbrains-mono text-silver-haze px-2 py-1.5 bg-charcoal-blue font-semibold xxs:text-center lg:text-justify text-sm rounded-sm">Here are some projects I have been working on recently.</p>
                </div>
                <div className="xxs:h-[37rem] lg:h-[29.5rem] xxs:w-[19.5rem] xs:w-[21rem] lg:w-full flex-row-center">
                    <p className="font-jetbrains-mono text-charcoal-blue font-extrabold xxs:text-[1rem] md:text-xl">Data could not be found!</p>
                </div>
            </div>
        </Section>
    )
