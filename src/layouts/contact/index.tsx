...
export default function Contact(): JSX.Element {
    ...
    return (
        <Section name="contact">
            <div className="xxs:h-[36rem] sm:h-[26rem] lg:h-[25rem] xxs:w-[19.5rem] xs:w-[21rem] s:-w-[22.5rem] s-plus:w-[24rem] s-medium:w-[25.5rem] sm:w-[29.5rem] md:w-[33rem] lg:w-[40rem] flex-col-center xxs:gap-3 sm:gap-1.5 lg:gap-0 border border-charcoal-blue/15 rounded-sm bg-silver-haze/15 backdrop-blur-sm">
                ...
                <div className="xxs:h-[16rem] sm:h-[13rem] lg:h-[13rem] w-full flex-col-center-start px-6 gap-4">
                    <p className="font-jetbrains-mono font-semibold select-none text-sm">
                        If you have questions about anything, please contact me via email.
                    </p>
                    <div className="w-full flex-row-center">
                        <Link draggable="false" href="mailto:angslhn@gmail.com" className="hoverable flex-row-center gap-3.5 mt-2.5 px-4 py-2 rounded-md bg-charcoal-blue hover:bg-charcoal-blue/85 transition-colors duration-300">
                ...
                <div className="py-2 w-full border-t border-charcoal-blue/15 flex-row-center flex-wrap xxs:gap-3 sm:gap-2">
                    ...
                    <div className="h-14 w-14 flex-row-center rounded-sm border border-charcoal-blue/15">
                        <Link draggable="false" href="https://www.youtube.com/@angslhn" target="_blank">
                            <svg className="hoverable text-charcoal-blue w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                    ...
                    <div className="h-14 w-14 flex-row-center rounded-sm border border-charcoal-blue/15">
                        <Link draggable="false" href="https://x.com/angslhn" target="_blank">
                            <svg className="hoverable text-charcoal-blue w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <div className="h-14 w-14 flex-row-center rounded-sm border border-charcoal-blue/15">
                        <Link draggable="false" href="https://t.me/angslhn" target="_blank">
                            <svg className="hoverable text-charcoal-blue w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
