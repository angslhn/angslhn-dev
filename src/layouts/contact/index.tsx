...
interface ContactProps { 
    localization: {
        en: ContactLocalization
        id: ContactLocalization
    }
}

interface ContactLocalization {
...
export default function Contact({ localization }: ContactProps): JSX.Element {
    ...
    return (
        <Section name="contact">
            <div className="py-2 xxs:w-[19.5rem] xs:w-[21rem] s:-w-[22.5rem] s-plus:w-[24rem] s-medium:w-[25.5rem] sm:w-[29.5rem] md:w-[33rem] lg:w-[40rem] flex-col-center xxs:gap-3 sm:gap-1.5 lg:gap-0 border border-charcoal-blue/15 rounded-sm bg-silver-haze/15 backdrop-blur-sm">
