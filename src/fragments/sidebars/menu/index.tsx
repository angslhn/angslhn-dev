        ...
        <nav ref={ menu } className="absolute w-[13rem] h-[15rem] top-[5rem] translate-x-48 border border-charcoal-blue/15 rounded-sm bg-silver-haze/15 backdrop-blur-sm">
            <ul className="flex-col-between text-charcoal-blue">
                <li className="flex relative items-center h-[3rem] w-full">
                    ...
                    <span onClick={() => Navigate("home")} className="absolute w-full text-center text-sm font-jetbrains-mono font-extrabold select-none hover:opacity-70">HOME</span>
                </li>
                <li className="flex relative items-center h-[3rem] w-full">
                    <svg className="ml-4 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                ...
                <li className="flex relative items-center h-[3rem] w-full">
                    ...
                    <span onClick={() => Navigate("project")} className="absolute w-full text-center text-sm font-jetbrains-mono font-extrabold select-none hover:opacity-70">PROJECT</span>
                </li>
                <li className="flex relative items-center h-[3rem] w-full">
                    <svg className="ml-4 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <span onClick={() => Navigate("contact")} className="absolute w-full text-center text-sm font-jetbrains-mono font-extrabold select-none hover:opacity-70">CONTACT</span>
                </li>
            </ul>
        </nav>
    )
