        ...
        <nav ref={ menu } className="absolute w-[13rem] h-[12rem] top-[5rem] translate-x-44 rounded-2xl border border-gray-950/15 backdrop-blur-sm bg-silver-haze/25 shadow[0.1rem_0.1rem_0.5rem] shadow-gray-600/15">
            <ul className="flex-col-between text-black-sapphire">
                <li className="flex relative items-center h-[3rem] w-full">
                    ...
                    <span onClick={() => Navigate("home")} className="absolute w-full text-center text-sm font-jetbrains-mono font-extrabold cursor-pointer select-none hover:opacity-70">HOME</span>
                </li>
                <li className="flex relative items-center h-[3rem] w-full">
                    <svg className="ml-4 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                    ...
                    <span onClick={() => Navigate("about")} className="absolute w-full text-center text-sm font-jetbrains-mono font-extrabold cursor-pointer select-none hover:opacity-70">ABOUT</span>
                </li>
                <li className="flex relative items-center h-[3rem] w-full">
                    ...
                    <span onClick={() => Navigate("project")} className="absolute w-full text-center text-sm font-jetbrains-mono font-extrabold cursor-pointer select-none hover:opacity-70">PROJECT</span>
                </li>
                <li className="flex relative items-center h-[3rem] w-full">
                    <svg className="ml-4 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <span onClick={() => Navigate("contact")} className="absolute w-full text-center text-sm font-jetbrains-mono font-extrabold cursor-pointer select-none hover:opacity-70">CONTACT</span>
                </li>
            </ul>
        </nav>
    )
