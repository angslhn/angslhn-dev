    ...
    return (
        <aside className="fixed flex-row-center top-0 left-0 h-screen w-16">
            <div ref={ socialmedia } className="py-1.5 w-14 flex-col-center gap-1.5 border border-charcoal-blue/15 rounded-sm bg-silver-haze/15 backdrop-blur-sm">
                ...
                <div className="h-12 w-full flex justify-center items-center">
                    <Link href="https://www.instagram.com/angslhn" target="_blank" className="hoverable">
                        <svg className="w-[2.4rem] text-charcoal-blue" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                ...
                <div className="h-12 w-full flex justify-center items-center">
                    <Link href="https://facebook.com/bae.slhn" target="_blank" className="hoverable">
                        <svg className="w-[2.4rem] text-charcoal-blue" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                ...
                <div className="h-12 w-full flex justify-center items-center">
                    <Link href="https://www.youtube.com/@angslhn" target="_blank" className="hoverable">
                ...
                <div className="h-12 w-full flex justify-center items-center">
                    <Link href="https://x.com/angslhn" target="_blank" className="hoverable">
                ...
                <div className="h-12 w-full flex justify-center items-center">
                    <Link href="https://www.linkedin.com/in/angslhn/" target="_blank" className="hoverable">
                        <svg className="w-[2.4rem] text-charcoal-blue" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                ...
                <div className="h-12 w-full flex justify-center items-center">
                    <Link href="https://t.me/angslhn" target="_blank" className="hoverable">
