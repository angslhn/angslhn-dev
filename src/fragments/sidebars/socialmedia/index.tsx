...
export default function SocialMedia() {
    ...
    return (
        <aside className="fixed flex-row-center top-0 left-0 h-screen w-16">
            <div ref={ socialmedia } className="py-2.5 w-full flex-col-center bg-silver-haze/25 border border-gray-950/15 rounded-tr-xl rounded-br-xl">
                <div className="h-16 w-full flex justify-center items-center">
                    <Link href="">
                        <svg className="w-[2.6rem]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                ...
                <div className="h-16 w-full flex justify-center items-center">
                    <Link href="">
                        <svg className="w-[2.8rem]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
