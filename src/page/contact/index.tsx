...
import type { Resolution, ContactContent } from "@/libs/types"
...
export default function Contact({ localization }: ContactProps): JSX.Element {
    ...
    useEffect(() => {
        ...
        if (section) section.classList.replace(width < 1024 || height < 601 ? "h-screen" : "h-[41rem]", width < 1024 || height < 601 ? "h-[41rem]" : "h-screen")
    }, [resolution])
    ...
    return (
        <Section name="contact">
            <div ref={ wrapperRef } className="h-full w-full flex-row-center">
                <div ref={ contactRef } className="py-2 xxs:w-[19.5rem] xs:w-[21rem] s:-w-[22.5rem] s-plus:w-[24rem] s-medium:w-[25.5rem] sm:w-[29.5rem] md:w-[33rem] lg:w-[40rem] flex-col-center xxs:gap-3 sm:gap-1.5 lg:gap-0 border border-charcoal-blue/15 rounded-sm bg-silver-haze/15 backdrop-blur-sm">
                    <div className="py-2 w-full flex-col-center-start gap-2.5 px-4 border-b border-charcoal-blue/15">
                        <h3 className="font-jetbrains-mono font-extrabold select-none text-3xl">
                            { locale === "en" ? localization.en.text_heading_title_1 : localization.id.text_heading_title_1 }
                        </h3>
                        <p className="font-jetbrains-mono font-semibold select-none text-sm text-justify">
                            { locale === "en" ? localization.en.description_1 : localization.id.description_1 }
                        </p>
                    </div>
                    <div className="py-2 w-full flex-col-center-start px-4 gap-3.5">
                        <p className="font-jetbrains-mono font-semibold select-none text-sm text-justify">
                            { locale === "en" ? localization.en.description_2 : localization.id.description_2 }
                        </p>
                        <div className="w-full flex-row-center">
                            <Link draggable="false" href="mailto:angslhn@gmail.com" className="big-hoverable flex-row-center gap-3.5 mt-2.5 px-4 py-2 rounded-md bg-charcoal-blue hover:bg-charcoal-blue/85 transition-colors duration-300">
                                <svg className="text-silver-haze w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                    <path className="fill-current" d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48L48 64zM0 176L0 384c0 35.3 28.7 64 64 64l384 0c35.3 0 64-28.7 64-64l0-208L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z"/>
                                </svg>
                                <span className="font-jetbrains-mono font-extrabold text-silver-haze">
                    ...
                    <div className="py-2 w-full border-t border-charcoal-blue/15 flex-row-center flex-wrap xxs:gap-3 sm:gap-2 lg:gap-6">
                        ...
                        <div className="h-14 w-14 flex-row-center rounded-sm border border-charcoal-blue/15">
                            <Link draggable="false" href="https://www.instagram.com/angslhn" target="_blank">
                                <svg className="big-hoverable text-charcoal-blue w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                        ...
                        <div className="h-14 w-14 flex-row-center rounded-sm border border-charcoal-blue/15">
                            <Link draggable="false" href="https://web.facebook.com/bae.slhn" target="_blank">
                                <svg className="big-hoverable text-charcoal-blue w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                        ...
                        <div className="h-14 w-14 flex-row-center rounded-sm border border-charcoal-blue/15">
                            <Link draggable="false" href="https://www.youtube.com/@angslhn" target="_blank">
                                <svg className="big-hoverable text-charcoal-blue w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                        ...
                        <div className="h-14 w-14 flex-row-center rounded-sm border border-charcoal-blue/15">
                            <Link draggable="false" href="https://x.com/angslhn" target="_blank">
                                <svg className="big-hoverable text-charcoal-blue w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        ...
                        <div className="h-14 w-14 flex-row-center rounded-sm border border-charcoal-blue/15">
                            <Link draggable="false" href="https://www.linkedin.com/in/angslhn/" target="_blank">
                                <svg className="big-hoverable text-charcoal-blue w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                        ...
                        <div className="h-14 w-14 flex-row-center rounded-sm border border-charcoal-blue/15">
                            <Link draggable="false" href="https://t.me/angslhn" target="_blank">
                                <svg className="big-hoverable text-charcoal-blue w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
