...
export default function Header(): JSX.Element {
    ...
    return (
        <header className="fixed top-0 left-0 z-50 flex-row-between items-center w-full h-16">
            <div className="h-full w-[8rem] flex-row-center border border-gray-950/15 rounded-br-md bg-silver-haze/25  shadow-[0.1rem_0.1rem_0.5rem] shadow-charcoal-blue/15">
            ...
            <div className="relative h-full w-[8rem] flex-row-center border border-gray-950/15 rounded-bl-md bg-silver-haze/25  shadow-[0.1rem_0.1rem_0.5rem] shadow-charcoal-blue/15">
                <svg onClick={() => toggleMenu() } className="hoverable h-16 text-gray-950" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
