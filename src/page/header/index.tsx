...
export default function Header(): JSX.Element {
    ...
    return (
        <header className="fixed top-0 left-0 z-50 flex-row-between items-center w-full h-16">
            <div className="h-full w-[8rem] flex-row-center border border-gray-950/15 rounded-br-md bg-silver-haze/25">
                <Link href="/" className="hoverable flex-row-center xxs:gap-0 lg:gap-0.5 hover:opacity-80 transition-opacity ease-in-out duration-200" draggable="false">
                    <svg className="xxs:w-12 lg:w-16 text-gray-950/80" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000">
            ...
            <div className="relative h-full w-[8rem] flex-row-center border border-gray-950/15 rounded-bl-md bg-silver-haze/25">
